...
public class DragControl extends ControlAdapter implements TableListener {
  ...
  /**
   * Creates a new drag control that optionally issues repaint requests as an item
   * is dragged.
   * 
   * @param repaint
   *          indicates whether or not repaint requests are issued as drag events
   *          occur. This can be set to false if other activities (for example, a
   *          continuously running force simulation) are already issuing repaint
   *          events.
   */
   ...
   *          indicates if object positions should become fixed (made stationary)
  ...
  /**
   * Determines whether or not an item should have it's position fixed when the
   * mouse moves over it.
   * 
   * @param s
   *          whether or not item position should become fixed upon mouse over.
   */
  ...
  /**
   * @see prefuse.data.event.TableListener#tableChanged(prefuse.data.Table, int,
   *      int, int, int)
   */
  @Override
