...
public class ZoomingPanControl extends ControlAdapter {
   ...
   * 
   * @param repaint
   *          true if repaint requests should be issued while panning and zooming.
   *          false if repaint requests will come from elsewhere (e.g., a
   *          continuously running action).
   */
