...
public class WheelZoomControl extends AbstractZoomControl {
   ...
   * scrolling the mouse wheel toward you will make the graph appear smaller. If
   * <tt>atPointer</tt> is true, zooming will be centered on the mouse pointer
   * instead of the center of the display.
   * 
   * @param inverted
  ...
  /**
   * Creates a new <tt>WheelZoomControl</tt> with the default zoom direction and
   * zooming on the center of the display.
   */
