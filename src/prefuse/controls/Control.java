...
public interface Control extends EventListener, MouseListener, MouseMotionListener, MouseWheelListener, KeyListener {
  ...
  /**
   * Invoked when the mouse cursor has been moved onto a VisualItem but no buttons
   * have been pushed.
   */
   ...
   * Display, but NOT on a VisualItem.
   */
  @Override
  public void mouseClicked(MouseEvent e);

  /**
   * Invoked when a mouse button is pressed on the Display (but NOT a VisualItem)
   * and then dragged.
   */
  @Override
