...
public class AnchorUpdateControl extends ControlAdapter {
   ...
   *          the name of an action to run upon anchor updates
   * @param overItem
   *          indicates if anchor update events should be processed while the
   *          mouse cursor is hovered over a VisualItem.
   */
  ...
  /**
   * Registers a mouse move event, updating the anchor point for all registered
   * layout instances.
   * 
   * @param e
   *          the MouseEvent
