...
public class TypeInferencer {
  ...
  /**
   * Create a new TypeInferencer using the default ParserFactory settings, thus
   * the default parsers and parser ordering will be used.
   */
  ...
  /**
   * Create a new TypeInferenced using the input ParserFactory as a template for
   * the desired parsers to check and parser ordering to use.
   * 
   * @param template
   *          the template ParserFactory to use for included parsers and their
   *          precedence.
   */
