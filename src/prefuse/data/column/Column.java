...
public interface Column {
  ...
  /**
   * Get the data parser used to map String values to and from the values stored
   * by this Column.
   * 
  ...
  /**
   * Set the data parser used to map String values to and from the values stored
   * by this Column.
   * 
   * @param parser
