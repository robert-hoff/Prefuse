...
public abstract class AbstractColumn implements Column {
   ...
   * different default value will not be changed as a result of this method; the
   * new default will apply to newly added rows only.
   * 
   * @param dflt
   */
  public void setDefaultValue(Object dflt) {
    ...
    if (dflt != null
        && ((!prim && !m_columnType.isInstance(dflt)) || (prim && !TypeLib.isWrapperInstance(m_columnType, dflt)))) {
  ...
  /**
   * Indicates if the get method can be called without an exception being thrown
   * for the given type.
   * 
   * @param type
  ...
  /**
   * Indicates if the set method can be called without an exception being thrown
   * for the given type.
   * 
   * @param type
   *          the Class of the data type to check
  ...
  /**
   * Indicates if convenience get method can be called without an exception being
   * thrown for the int type.
   * 
  ...
  /**
   * Indicates if convenience set method can be called without an exception being
   * thrown for the int type.
   * 
