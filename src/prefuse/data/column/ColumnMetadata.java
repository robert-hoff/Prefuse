...
public class ColumnMetadata implements ColumnListener {
   ...
   *          the name of the column to store metadata for
   * @param cmp
   *          a Comparator that determines the default sort order for values in
   *          the column
   * @param dynamic
   *          indicates if this ColumnMetadata should react to changes in the
   *          underlying table values. If true, computed values stored in this
   *          metadata object will be invalidated when updates to the column data
   *          occur.
   */
  ...
  /**
   * Get the row index of the minimum column value. If there are multiple minima,
  ...
  /**
   * Get the row index of the maximum column value. If there are multiple maxima,
   * only one is returned.
   * 
  ...
  /**
   * Get the mean value of numeric values in the column. If this column does not
   * contain numeric values, this method will result in an exception being thrown.
   * 
   ...
   * does not contain numeric values, this method will result in an exception
   * being thrown.
   * 
  ...
  /**
   * Get the sum of numeric values in the column. If this column does not contain
   * numeric values, this method will result in an exception being thrown.
   * 
   ...
   * 
   * @return a map between all unique column values and their integer index in the
   *         values' sort order
   */
