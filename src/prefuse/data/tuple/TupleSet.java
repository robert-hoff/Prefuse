...
public interface TupleSet {
  ...
  /**
   * Add a Tuple to this TupleSet. This method is optional, and may result in an
   * UnsupportedOperationException on some TupleSet implementations.
   * 
   * @param t
   *          the Tuple add
   * @return the actual Tuple instance stored in the TupleSet. This may be null to
   *         signify that the add failed, may be a new Tuple with values copied
   *         from the input tuple, or may be the input Tuple itself.
   */
  public Tuple addTuple(Tuple t);

  /**
   * Set the TupleSet contents to be a single Tuple. This method is optional, and
   * may result in an UnsupportedOperationException on some TupleSet
   * implementations.
   * 
   * @param t
  ...
  /**
   * Add the data fields of the given Schema to the Tuples in this TupleSet. If
   * this TupleSet contains heterogeneous Tuples (i.e., those from different
   * source tables), all backing tables involved will be updated.
   * 
   * @param s
   ...
   *          the name of the data field
   * @param expr
   *          an uncompiled expression in the prefuse expression language. This
   *          will be compiled to a valid expression, and the results of applying
   *          the expression to a Tuple will become the data field value for that
   *          Tuple.
   ...
   *          results of applying the expression to a Tuple will become the data
  ...
  /**
   * Return an iterator over the tuples in this tuple set, filtered by the given
   * predicate.
   * 
   * @param filter
   *          predicate to apply to tuples in this set, only tuples for which the
   *          predicate evaluates to true are included in the iteration
   ...
   * @param filter
   *          predicate to apply to tuples in this set, only tuples for which the
   *          predicate evaluates to true are included in the iteration. If this
   *          value is null, no filtering will be performed.
   * @param sort
  ...
  /**
   * Add a listener to this tuple set that will be notified when tuples are added
  ...
  /**
   * Add a PropertyChangeListener to be notified of changes to a specific property
   * bound to this TupleSet.
   * 
   * @param key
