...
public class CompositeTupleSet extends AbstractTupleSet {
   ...
   * @return true if the TupleSet is contained in this composite, false otherwise
   */
  ...
  /**
   * Clear this TupleSet, calling clear on all contained TupleSet instances. All
   * contained TupleSets remain members of this composite, but they have their
   * data cleared.
   * 
  ...
  /**
   * Removes the tuple from its source set if that source set is contained within
   * this composite.
   * 
  ...
  /**
   * Listener that relays tuple set change events as they occur and updates the
   * total tuple count appropriately.
   */
