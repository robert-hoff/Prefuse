...
public class ListQueryBinding extends DynamicQueryBinding {
   ...
   *          indicates if the dynamic queries should include an "All" option for
   *          including all data values
   */
   ...
   * 
   * @return a {@link prefuse.util.ui.JToggleGroup} of check boxes bound to this
   *         dynamic query.
   ...
   * 
   * @return a {@link prefuse.util.ui.JToggleGroup} of radio buttons bound to this
   *         dynamic query.
   */
