...
public class ObjectRangeModel extends DefaultBoundedRangeModel implements ValuedRangeModel {
  ...
  /**
   * Create a new ObjectRangeModel with the given objects. The objects are assumed
   * to sorted in ascending order.
   * 
   * @param objects
   *          the members of this ObjectRangeModel, sorted in ascending order.
   */
  ...
  /**
   * Sets the range model to the given objects. The objects are assumed to sorted
   * in ascending order.
   * 
   * @param objects
   *          the members of this ObjectRangeModel, sorted in ascending order.
   ...
   * @return the index of the Object in the range model, -1 if the Object is not
   *         found in the model.
   */
