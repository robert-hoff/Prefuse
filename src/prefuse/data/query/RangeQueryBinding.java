...
public class RangeQueryBinding extends DynamicQueryBinding {
  ...
  /**
   * Create a new RangeQueryBinding over the given set and data field, optionally
   * forcing an ordinal treatment of data.
   * 
   * @param ts
   *          the TupleSet to query
   * @param field
   *          the data field (Table column) to query
   * @param forceOrdinal
   *          if true, forces all items in the range to be treated in strictly
   *          ordinal fashion. That means that if the data is numerical, the
   *          quantitative nature of the data will be ignored and only the
   *          relative ordering of the numbers will matter. In terms of mechanism,
   *          this entails that a {@link ObjectRangeModel} and not a
   *          {@link NumberRangeModel} will be used to represent the data. If the
   *          argument is false, default inference mechanisms will be used.
   */
  ...
  /**
   * Return the ValuedRangeModel constructed by this dynamic query binding. This
   * model backs any user interface components generated by this instance.
   * 
   ...
   * 
   * @return the ValuedRangeModel for this binding as a {@link NumberRangeModel},
   *         or null if the range is not numerical.
   */
   ...
   * 
   * @return the ValuedRangeModel for this binding as an {@link ObjectRangeModel},
   *         or null if the range is numerical.
   */
   ...
   * 
   * @return a {@link prefuse.util.ui.JRangeSlider} bound to this dynamic query.
  ...
  /**
   * Create a new regular (non-range) slider for interacting with the query. This
   * allows you to select a single value at a time.
   * 
