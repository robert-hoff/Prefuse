...
public class Trie {
  ...
  /**
   * A TrieNode implementation representing a leaf in the tree. The class stores
   * the word and tuple for the leaf, as well as a reference to the successor leaf
   * node in the trie.
   */
   ...
   * 
   * @param caseSensitive
   *          true if the index should be case sensitive for indexed words, false
   *          otherwise.
   */
   ...
   * returned. This node is the root of a subtree containing all the matches to
   * the query.
   * 
   * @param word
   *          the word to lookup
   * @return the TrieNode root of the subtree containing all matches. A null value
