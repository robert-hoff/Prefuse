...
public class PrefixSearchTupleSet extends SearchTupleSet {
   ...
   * separate words. By default, the value consists of just whitespace characters.
   * 
   ...
   * 
   * @param delim
   *          the delimiter string to use. This is passed as an argument to a
   *          {@link java.util.StringTokenizer} instance that will tokenize the
   *          text.
   * @see java.util.StringTokenizer
   */
  ...
  /**
   * Searches the indexed Tuple fields for matching string prefixes, adding the
   * Tuple instances for each search match to this TupleSet. The query string is
   * first broken up into separate terms, as determined by the current delimiter
   * string. A search for each term is conducted, and all matching Tuples are
