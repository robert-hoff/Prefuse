...
public abstract class BinaryExpression extends AbstractExpression {
   ...
   * 
   * @param operation
   *          int value indicating the operation to be performed on the subtrees.
   *          The actual range of acceptable values are determined by subclasses.
   * @param minOp
  ...
  /**
   * Get the operation code for this expression. The meaning of this code is left
   * for subclasses to determine.
   * 
