...
public class FunctionTable {
  ...
  /**
   * Add a function to the function table. It will then become available for use
   * with compiled statements of the prefuse expression language.
   * 
   * @param name
   *          the name of the function. This name must not already be registered
   *          in the table, i.e. there is no function overloading.
   * @param type
