...
public class RowManager {
   ...
   * @return true if the row is valid and in use by the Table, false if it is an
   *         illegal value or is currently free
   */
   ...
   * @return true if the row was successfully released, false if it was already
   *         free or if the input is not a valid row index
   */
   ...
   * underlying data column. This is of use for CascadedTable instances, which may
   * reveal only a limited set of a parent table's rows and so must map between
   * table rows and the actual indices of the inherited data columns.
   * 
   * @param row
   *          the table row
   * @param col
   *          the table column
   * @return the row value for accessing the correct value of the referenced data
   *         column.
   */
   ...
   * instances, which may reveal only a limited set of a parent table's rows and
   * so must map between table rows and the actual indices of the inherited data
   * columns.
   * 
   * @param columnRow
   ...
   * @param col
   *          the table column
   * @return the row value for the Table that corresponds to the given column row
   */
   ...
   * @return an iterator over column row indices corresponding to valid rows of
   *         this RowManager
   */
   ...
   *          the table column index
   * @param reverse
   *          indicates the direction to iterate over, true for reverse, false for
   *          normal
   * @return an iterator over column row indices corresponding to valid rows of
   *         this RowManager
   */
  ...
  /**
   * Iterator over the indices into a given data column, mapped to from the rows
   * of this RowManager.
   */
