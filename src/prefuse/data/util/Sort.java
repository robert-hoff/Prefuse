...
public class Sort {
  ...
  /**
   * Creates a new Sort specification that sorts on the given fields in the given
   * orders.
   * 
   * @param fields
   *          the fields to sort on, in order of precedence
   * @param ascend
   *          for each field, indicates if the field should be sorted in ascending
   ...
   * @return a Comparator instance for sorting tuples from the given set using the
   *         sorting criteria given in this specification
   */
  ...
  /**
   * Parse a comma-delimited String of data fields to sort on, along with optional
   * ASC or DESC modifiers, to generate a new Sort specification. This string
   * should consist of a comma-delimited list of field names, which optional "ASC"
   * or "DESC" modifiers to specify ascending or descending sorts. If no modifier
   * is given, ascending order is assumed. Field names which include spaces or
   * other non-standard characters should be written in brackets ([]), just as is
