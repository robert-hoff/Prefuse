...
public class FilteredRowManager extends RowManager {
  ...
  /**
   * Given a row in the parent table, return the corresponding row managed by this
   * manager.
   * 
   * @param parentRow
  ...
  /**
   * Remove a mapping between the given managed row and the corresponding parent
   * row.
   * 
   * @param childRow
   *          a row managed by this manager
