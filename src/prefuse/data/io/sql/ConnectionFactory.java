...
public class ConnectionFactory {
   ...
   * 
   * @param driver
   *          the database driver to use, must resolve to a valid Java class on
   ...
   * @param handler
   *          the sql data handler to use
   * @return a DatabaseDataSource for interacting with the database
   * @throws SQLException
   * @throws ClassNotFoundException
   */
  public static DatabaseDataSource getDatabaseConnection(String driver, String url, String user, String password,
      SQLDataHandler handler) throws SQLException, ClassNotFoundException {
  ...
  public static DatabaseDataSource getDatabaseConnection(String driver, String url, String user, String password)
    ...
    return getDatabaseConnection(driver, url, user, password, getDefaultHandler());
  }
   ...
   * @param database
   *          the name of the particular database to use
   * @param user
   *          the database username
   * @param password
   *          the database password
   ...
   * @throws ClassNotFoundException
   */
  public static DatabaseDataSource getMySQLConnection(String host, String database, String user, String password,
      SQLDataHandler handler) throws SQLException, ClassNotFoundException {
    String url = PROTOCOL_JDBC + SUBPROTOCOL_MYSQL + "//" + host + "/" + database;
