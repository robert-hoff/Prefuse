 ...
 * involves just a single thread, in the future this may be expanded to thread
 * pool for greater concurrency.
 * 
...
public class DataSourceWorker extends Thread {
   ...
   * 
   * @param e
   *          an {@link DataSourceWorker.Entry} instance that contains the
  ...
  public static class Entry {
     ...
     *          the query to issue
     * @param keyField
     *          the key field that should be used to identify when duplicate results
     *          occur
     * @param lock
     *          an optional lock to synchronize on when processing data and adding
     *          it to the Table
     * @param listener
     *          an optional callback listener that allows notifications to be issued
     *          before and after query processing
     */
    ...
    /**
     * An optional callback listener that allows notifications to be issued before
     * and after query processing.
     */
    Listener listener;
    /** The Table for storing the results. */
    Table table;
    ...
    String query;
    /**
     * The key field that should be used to identify when duplicate results occur.
     */
    String keyField;
    /**
     * An optional lock to synchronize on when processing data and adding it to the
     * Table.
     */
    Object lock;
  }
  ...
  /**
   * Listener interface for receiving notifications about the status of a
   * submitted data query and processing job.
   * 
   * @author <a href="http://jheer.org">jeffrey heer</a>
   */
