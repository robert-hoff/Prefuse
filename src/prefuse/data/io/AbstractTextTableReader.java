...
public abstract class AbstractTextTableReader extends AbstractTableReader {
   ...
   * 
   * @param parserFactory
   *          the ParserFactory to use for parsing text strings into table values.
   */
   ...
   * 
   * @param hasHeaderRow
   *          true if the the data file includes a header row, false otherwise.
   */
  ...
  /**
   * Scans the input stream, making call backs for each encountered entry on the
   * provided TextReadListener.
   * 
   * @param is
