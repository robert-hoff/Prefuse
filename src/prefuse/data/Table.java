...
public class Table extends AbstractTupleSet implements ColumnListener {
  ...
  /**
   * Mapping between column names and column entries containing column, metadata,
  ...
  /**
   * Memoize the index of the last column operated on, used to expedite handling
   * of column updates.
   */
  ...
  /**
   * Create a new Table with a given number of rows, and the starting capacity for
  ...
  /**
   * Get the number of times this Table has been modified. Adding rows, deleting
   * rows, and updating table cell values all contribute to this count.
   * 
  ...
  /**
   * Sets the TupleManager used by this Table. Use this method carefully, as it
   * will cause all existing Tuples retrieved from this Table to be invalidated.
   * 
   * @param tm
  ...
  /**
   * Returns this Table's schema. The returned schema will be locked, which means
   * that any attempts to edit the returned schema by adding additional columns
   * will result in a runtime exception.
   * 
   * If this Table subsequently has columns added or removed, this will not be
   * reflected in the returned schema. Instead, this method will need to be called
   * again to get a current schema. Accordingly, it is not recommended that Schema
   * instances returned by this method be stored or reused across scopes unless
   * that exact schema snapshot is desired.
   * 
  ...
  /**
   * Invalidates this table's cached schema. This method should be called whenever
   * columns are added or removed from this table.
   */
  ...
  /**
   * Get the row value for accessing an underlying Column instance, corresponding
   * to the given table cell. For basic tables this just returns the input row
   * value. However, for tables that inherit data columns from a parent table and
   * present a filtered view on this data, a mapping between the row numbers of
   * the table and the row numbers of the backing data column is needed. In those
   * cases, this method returns the result of that mapping. The method
   * {@link #getTableRow(int, int)} accesses this map in the reverse direction.
   * 
   * @param row
   ...
   * column and the column number for the data column. For basic tables this just
   * returns the column row value. However, for tables that inherit data columns
   * from a parent table and present a filtered view on this data, a mapping
   * between the row numbers of the table and the row numbers of the backing data
   * column is needed. In those cases, this method returns the result of this
   * mapping, in the direction of the backing column rows to the table rows of the
   * cascaded table. The method {@link #getColumnRow(int, int)} accesses this map
  ...
  /**
   * Add a row to this table. All data columns will be notified and will take on
   * the appropriate default values for the added row.
   * 
  ...
  /**
   * Add a given number of rows to this table. All data columns will be notified
   * and will take on the appropriate default values for the added rows.
   * 
   * @param nrows
   ...
   *          the data field name for the column
   * @param expr
   *          a String expression in the prefuse expression language, to be parsed
   *          into an {@link prefuse.data.expression.Expression} instance. The
  ...
  /**
   * Add a constant column to this table, which returns one constant value for all
   * column rows.
   * 
   * @param name
   *          the data field name for the column
   ...
   * first call to this method with a given field name will cause the index to be
   * created and stored. Subsequent calls will simply return the stored index. To
   * attempt to retrieve an index without triggering creation of a new index, use
   * the {@link #getIndex(String)} method.
   * 
   * @param field
   ...
   * @param field
   *          the data field name of the column
   * @return the stored index for the column, or null if no index has been created
   */
   ...
   * @return true if an index was successfully removed, false if no such index was
   *         found
   */
  ...
  /**
   * Get the Tuple instance providing object-oriented access to the given table
   * row.
   * 
   * @param row
   *          the table row
  ...
  /**
   * Add a Tuple to this table. If the Tuple is already a member of this table,
   * nothing is done and null is returned. If the Tuple is not a member of this
   * Table but has a compatible data schema, as determined by
   * {@link Schema#isAssignableFrom(Schema)}, a new row is created, the Tuple's
   * values are copied, and the new Tuple that is a member of this Table is
   * returned. If the data schemas are not compatible, nothing is done and null is
   * returned.
   * 
   * @param t
  ...
  /**
   * Clears the contents of this table and then attempts to add the given Tuple
   * instance.
   * 
   * @param t
  ...
  /**
   * Remove a tuple from this table. If the Tuple is a member of this table, its
   * row is deleted from the table. Otherwise, nothing is done.
   * 
   * @param t
   *          the Tuple to remove from the table
   * @return true if the Tuple row was successfully deleted, false if the Tuple is
   *         invalid or not a member of this table
   ...
   * @return true if the Tuple represents a row of this table, false if it does
   *         not
  ...
  /**
   * Check if the <code>get</code> method for the given data field returns values
   * that are compatible with a given target type.
   * 
   * @param field
   *          the data field to check
   * @param type
   *          a Class instance to check for compatibility with the data field
   *          values.
   ...
   *         used as parameters of the {@link #set(int, String, Object)} method.
   ...
   * @param val
   *          the value for the field. If the concrete type of this Object is not
   *          compatible with the underlying data model, an Exception will be
   *          thrown. Use the {@link #canSet(String, Class)} method to check the
   *          type-safety ahead of time.
   ...
   * @param field
   *          the data field
   * @return the default value, as an Object, used to populate rows of the data
   *         field.
   */
  ...
  /**
   * Revert this tuple's value for the given field to the default value for the
   * field.
   * 
   * @param field
   *          the data field
  ...
  /**
   * Check if the given data field can return primitive <code>int</code> values.
   * 
   * @param field
   *          the data field to check
   * @return true if the data field can return primitive <code>int</code> values,
   *         false otherwise. If true, the {@link #getInt(int, String)} method can
   *         be used safely.
   */
  ...
  /**
   * Check if the <code>setInt</code> method can safely be used for the given data
   * field.
   * 
   * @param field
   *          the data field to check
   * @return true if the {@link #setInt(int, String, int)} method can safely be
  ...
  /**
   * Check if the given data field can return primitive <code>long</code> values.
   * 
   * @param field
   *          the data field to check
   * @return true if the data field can return primitive <code>long</code> values,
   *         false otherwise. If true, the {@link #getLong(int, String)} method
   *         can be used safely.
   */
   ...
   * @param field
   *          the data field to check
   * @return true if the {@link #setLong(int, String, long)} method can safely be
   *         used for the given field, false otherwise.
   */
  ...
  /**
   * Check if the given data field can return primitive <code>float</code> values.
   * 
   * @param field
   *          the data field to check
  ...
  /**
   * Check if the <code>setFloat</code> method can safely be used for the given
   * data field.
   * 
   * @param field
   *          the data field to check
   * @return true if the {@link #setFloat(int, String, float)} method can safely
  ...
  /**
   * Check if the <code>setDouble</code> method can safely be used for the given
   * data field.
   * 
   * @param field
   *          the data field to check
   * @return true if the {@link #setDouble(int, String, double)} method can safely
   *         be used for the given field, false otherwise.
   */
  ...
  /**
   * Check if the <code>setBoolean</code> method can safely be used for the given
   * data field.
   * 
   * @param field
   *          the data field to check
  ...
  /**
   * Check if the <code>setString</code> method can safely be used for the given
   * data field.
   * 
   * @param field
   *          the data field to check
   * @return true if the {@link #setString(int, String, String)} method can safely
   *         be used for the given field, false otherwise.
   */
   ...
   * @param field
   *          the data field to check
   * @return true if the data field can return primitive <code>Date</code> values,
   *         false otherwise. If true, the {@link #getDate(int, String)} method
   *         can be used safely.
   */
   ...
   * @param field
   *          the data field to check
   * @return true if the {@link #setDate(int, String, Date)} method can safely be
   *         used for the given field, false otherwise.
   */
  ...
  /**
   * Query this table for a filtered, sorted subset of this table. This operation
   * creates an entirely new table independent of this table. If a filtered view
   * of this same table is preferred, use the {@link CascadedTable} class.
   * 
   * @param filter
   *          the predicate filter determining which rows to include in the new
   *          table. If this value is null, all rows will be included.
   * @param sort
   *          the sorting criteria determining the order in which rows are added
   *          to the new table. If this value is null, the rows will not be
   *          sorted.
  ...
  /**
   * Get a filtered iterator over the row numbers of this table, returning only
   * the rows whose tuples match the given filter predicate.
   * 
   * @param filter
   ...
   * This method will create an index over the field if one does not yet exist.
   * 
   * @param field
   *          the data field to sort by
   * @param ascend
   *          true if the iteration should proceed in an ascending (lowest to
   *          highest) sort order, false for a descending order
   ...
   * bounded range for a given data field. A new index over the data field will be
   ...
   * @param indexType
   *          indicate the sort order and inclusivity/exclusivity of the range
   *          bounds, using the constants of the {@link prefuse.data.util.Index}
   *          class.
  ...
  /**
   * Helper class that encapsulates a map entry for a column, including the column
   * itself and its metadata and index.
   * 
   * @author <a href="http://jheer.org">jeffrey heer</a>
   */
  protected static class ColumnEntry {
    ...
    /**
     * Dispose of this column entry, disposing of any allocated metadata or index
     * instances.
     */
    public void dispose() {
      if (metadata != null) {
