...
public interface Tuple {
   ...
   * 
   * @return the backing row index, or -1 if there is no backing table or if this
   *         Tuple has been invalidated (i.e., the Tuple's row was deleted from
   *         the backing table).
   */
  public int getRow();

  /**
   * Indicates if this Tuple is valid. Trying to get or set values on an invalid
   * Tuple will result in a runtime exception.
   * 
   ...
   * @param field
   *          the data field
   * @return the data type of the field, a Class instance indicating the top-level
   *         type of data values in this field.
   */
   ...
   * @return the column index of the field within the backing table, or -1 if no
   *         columns with the given name were found
   */
   ...
   *         false otherwise. If true, the {@link #getInt(String)} method can be
   *         used safely.
   */
   ...
   * @param field
   *          the data field to check
   * @return true if the {@link #setInt(String, int)} method can safely be used
   *         for the given field, false otherwise.
   */
   ...
   *         false otherwise. If true, the {@link #getLong(String)} method can be
   *         used safely.
   */
   ...
   * @param field
   *          the data field to check
   * @return true if the {@link #setLong(String, long)} method can safely be used
   *         for the given field, false otherwise.
   */
   ...
   * @param field
   *          the data field to check
   * @return true if the {@link #setDouble(String, double)} method can safely be
   *         used for the given field, false otherwise.
   */
   ...
   * @param field
   *          the data field to check
   * @return true if the {@link #setBoolean(String, boolean)} method can safely be
   *         used for the given field, false otherwise.
   */
   ...
   * @param field
   *          the data field to check
   * @return true if the data field can return <code>String</code> values, false
   *         otherwise. If true, the {@link #getString(String)} method can be used
   *         safely.
   */
   ...
   * @param field
   *          the data field to check
   * @return true if the {@link #setString(String, String)} method can safely be
   *         used for the given field, false otherwise.
   */
   ...
   *         otherwise. If true, the {@link #getDate(String)} method can be used
   *         safely.
   */
   ...
   * @param field
   *          the data field to check
   * @return true if the {@link #setDate(String, Date)} method can safely be used
   *         for the given field, false otherwise.
   */
