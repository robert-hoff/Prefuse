...
public class CascadedTable extends Table {
  ...
  /**
   * ColumnProjection determining which columns of the parent table are included
   * in this table.
   */
  protected ColumnProjection m_colFilter;
  /**
   * Selection Predicate determining which rows of the parent table are included
   * in this table.
   */
  ...
  /**
   * Create a new CascadedTable. By default all columns of the parent table are
   * included in this one.
   * 
   * @param parent
   *          the parent Table to use
   * @param rowFilter
   *          a Predicate determining which rows of the parent table to include in
   *          this one.
   */
   ...
   *          the parent Table to use
   * @param colFilter
   *          a ColumnProjection determining which columns of the parent table to
   *          include in this one.
   */
  ...
  /**
   * Manually trigger a re-filtering of the rows of this table. If the filtering
   * predicate concerns only items within this table, calling this method should
   * be unnecessary. It is only when the filtering predicate references data
   * outside of this table that a manual re-filtering request may be necessary.
   * For example, filtering valid edges of a graph from a pool of candidate edges
   * will depend on the available nodes.
   * 
  ...
  /**
   * Get the ColumnProjection determining which columns of the parent table are
   * included in this one.
   * 
  ...
  /**
   * Sets the ColumnProjection determining which columns of the parent table are
   * included in this one.
   * 
   * @param colFilter
   *          a ColumnProjection determining which columns of the parent table to
  ...
  /**
   * Gets ths Predicate determining which rows of the parent table are included in
   * this one.
   * 
  ...
  /**
   * Sets the Predicate determining which rows of the parent table are included in
   * this one.
   * 
   * @param rowFilter
   *          a Predicate determining which rows of the parent table to include in
  ...
  /**
   * Get the number of columns explicitly stored by this table (i.e., all columns
   * that are not inherited from the parent table).
   * 
   ...
   * @return the corresponding row in this table, or -1 if the given parent row is
   *         not inherited by this table
   */
  ...
  /**
   * Internal listener class handling updates from the backing parent table, the
   * column projection, or the row selection predicate.
   */
