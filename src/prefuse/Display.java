...
public class Display extends JComponent {
  ...
  /**
   * Creates a new Display instance. You will need to associate this Display with
   * a {@link Visualization} for it to display anything.
   */
  public Display() {
    this(null);
  }
  ...
  /**
   * Creates a new Display associated with the given Visualization. By default,
   * all {@link prefuse.visual.VisualItem} instances in the {@link Visualization}
  ...
  /**
   * Creates a new Display associated with the given Visualization that draws all
   * VisualItems in the visualization that pass the given Predicate. The predicate
   * string will be parsed by the
   ...
   *          the {@link Visualization} backing this Display
   * @param predicate
   *          a predicate expression in the prefuse expression language. This
   *          expression will be parsed; if the parsing fails or does not result
   *          in a Predicate instance, an exception will result.
   */
  ...
  /**
   * Creates a new Display associated with the given Visualization that draws all
   * VisualItems in the visualization that pass the given Predicate.
   * 
   * @param visualization
   *          the {@link Visualization} backing this Display
   * @param predicate
  ...
  /**
   * Resets the display by clearing the offscreen buffer and flushing the internal
   * rendering queue. This method can help reclaim memory when a Display is not
   * visible.
   */
  public void reset() {
    m_offscreen = null;
   ...
   * </ul>
   * Subclasses can override this method to prevent these commands from being set.
   * Additional commands can be registered using the
  ...
  /**
   * Indicates if the Display is using high quality (return value true) or regular
   * quality (return value false) rendering.
   * 
  ...
  /**
   * Set the Visualiztion associated with this Display. This Display will render
   * the items contained in the provided visualization. If this Display is already
   * associated with a different Visualization, the Display unregisters itself
  ...
  /**
   * Returns the filtering Predicate used to control what items are drawn by this
   * display.
   * 
   ...
   * 
   * @param expr
   *          the filtering predicate to use. The predicate string will be parsed
   *          by the {@link prefuse.data.expression.parser.ExpressionParser}. If
   *          the parse fails or does not result in a
   *          {@link prefuse.data.expression.Predicate} instance, an exception
   *          will be thrown.
   */
  ...
  /**
   * Returns the number of visible items processed by this Display. This includes
   * items not currently visible on screen due to the current panning or zooming
   * state.
   * 
   ...
   * Items are drawn in ascending order of the scores provided by the ItemSorter.
   * 
   ...
   * @param tileImage
   *          true to tile the image across the visible background, false to only
   *          include the image once
   */
   ...
   *          {@link prefuse.util.io.IOLib#urlFromString(String)} to resolve the
   *          String. If a null value is provided, than no background image will
   *          be shown.
   * @param fixed
   *          true if the background image should stay in a fixed position,
   *          invariant to panning, zooming, or rotation; false if the image
  ...
  /**
   * Returns the tooltip instance to use for this Display. By default, uses the
   * normal Swing tooltips, returning the result of this same method invoked on
   * the JComponent super-class. If a custom tooltip has been set, that is
   * returned instead.
   * 
  ...
  /**
   * Set a custom tooltip to use for this Display. To trigger tooltip display, you
   * must still use the <code>setToolTipText</code> method as usual. The actual
   * text will no longer have any effect, other than that a null text value will
   * result in no tooltip display while a non-null text value will result in a
   * tooltip being shown. Clients are responsible for setting the tool tip text to
   * enable/disable tooltips as well as updating the content of their own custom
   * tooltip instance.
   * 
   * @param tooltip
  ...
  /**
   * Get the custom tooltip used by this Display. Returns null if normal tooltips
   * are being used.
   * 
  ...
  /**
   * Indicates if damage/redraw rendering is enabled. If enabled, the display will
   * only redraw within the bounding box of all areas that have changed since the
   * last rendering operation. For small changes, such as a single item being
   * dragged, this can result in a significant performance increase. By default,
   * the damage/redraw optimization is enabled. It can be disabled, however, if
   * rendering artifacts are appearing in your visualization. Be careful though,
   * as this may not be the best solution. Rendering artifacts may result because
   * the item bounds returned by {@link prefuse.visual.VisualItem#getBounds()} are
   * not accurate and the item's {@link prefuse.render.Renderer} is drawing
   * outside of the reported bounds. In this case, there is usually a bug in the
   * Renderer. One reported problem arises from Java itself, however, which
   * inaccurately redraws images outside of their reported bounds. If you have a
   * visulization with a number of images and are seeing rendering artifacts, try
   * disabling damage/redraw.
   * 
   * @return true if damage/redraw optimizations are enabled, false otherwise (in
   *         which case the entire Display is redrawn upon a repaint)
   */
  ...
  /**
   * Sets if damage/redraw rendering is enabled. If enabled, the display will only
   * redraw within the bounding box of all areas that have changed since the last
   * rendering operation. For small changes, such as a single item being dragged,
   * this can result in a significant performance increase. By default, the
   * damage/redraw optimization is enabled. It can be disabled, however, if
   * rendering artifacts are appearing in your visualization. Be careful though,
   * as this may not be the best solution. Rendering artifacts may result because
   * the item bounds returned by {@link prefuse.visual.VisualItem#getBounds()} are
   * not accurate and the item's {@link prefuse.render.Renderer} is drawing
   ...
   * 
   * @param b
   *          true to enable damage/redraw optimizations, false otherwise (in
   *          which case the entire Display will be redrawn upon a repaint)
   */
  ...
  /**
   * Clears any reports of damaged regions, causing the Display to believe that
   * the display contents are up-to-date. If used incorrectly this can cause
   * inaccurate rendering. <strong>Call this method only if you know what you are
   * doing.</strong>
   */
  ...
  /**
   * Returns the bounds, in absolute (item-space) coordinates, of the total bounds
   * occupied by all currently visible VisualItems. This method allocates a new
   * Rectangle2D instance for the result.
   * 
  ...
  /**
   * Returns the bounds, in absolute (item-space) coordinates, of the total bounds
   * occupied by all currently visible VisualItems.
   * 
   * @param b
   ...
   * @param scale
   *          how much to scale the image by. For example, a value of 2.0 will
   *          result in an image with twice the pixel width and height of this
   *          Display.
  ...
  /**
   * Immediately repaints the contents of the offscreen buffer to the screen. This
  ...
  /**
   * Sets the transform of the provided Graphics context to be the transform of
   * this Display and sets the desired rendering hints.
   * 
   * @param g
  ...
  /**
   * Sets the rendering hints that should be used while drawing the visualization
   * to the screen. Subclasses can override this method to set hints as desired.
   * Such subclasses should consider honoring the high quality flag in one form or
   * another.
   * 
   * @param g
  ...
  /**
   * Immediately render the given VisualItem to the screen. This method bypasses
   * the Display's offscreen buffer.
   * 
   * @param item
   ...
   * This method does not double buffer the painting, in order to provide the
   * maximum print quality.
   * 
   * <b>This method may not be working correctly, and will be repaired at a later
   * date.</b>
   * 
   * @param g
  ...
  /**
   * Returns a reference to the AffineTransformation used by this Display. Changes
   * made to this reference WILL corrupt the state of this display. Use
   * setTransform() to safely update the transform state.
   * 
  ...
  /**
   * Returns a reference to the inverse of the AffineTransformation used by this
   * display. Direct changes made to this reference WILL corrupt the state of this
   * display.
   * 
   ...
   * @param abs
   *          a reference to put the result in. If this is the same object as the
   *          screen co-ordinate, it will be overridden safely. If this value is
   *          null, a new Point2D instance will be created and returned.
   ...
   * 
   * @return the current scale. This is the scaling factor along the x-dimension,
   *         so be careful when using this value in rare non-uniform scaling
   *         cases.
   */
   ...
   * 
   * @param p
   *          the anchor point for the rotation, in absolute (i.e. item-space)
   *          co-ordinates
   * @param theta
  ...
  /**
   * Animate a pan to the specified location in screen (pixel) co-ordinates using
  ...
  /**
   * Animate a pan to the specified location in absolute (item-space) co-ordinates
   * using the provided duration.
   * 
   * @param p
  ...
  /**
   * Animate a zoom centered on a given location in screen (pixel) co-ordinates by
   * the given scale using the provided duration.
   * 
   * @param p
  ...
  /**
   * Animate a pan to the specified location in screen (pixel) co-ordinates and
   * zoom to the given scale using the provided duration.
   * 
   * @param p
   *          the point to center on in screen (pixel) units
   * @param scale
  ...
  /**
   * Add an ItemBoundsListener to receive notifications when the bounds occupied
   * by the VisualItems in this Display change.
   * 
   * @param ibl
   ...
   * widget spaning the item's bounding box. Use stopEditing() to hide the text
   * widget. When stopEditing() is called, the data field will automatically be
  ...
  /**
   * Edit text for the given VisualItem and field. Presents a text editing widget
   * spaning the given bounding box. Use stopEditing() to hide the text widget.
   * When stopEditing() is called, the field will automatically be updated with
   * the VisualItem.
   * 
   * @param item
   *          the VisualItem to edit
   ...
   *          the attribute to edit
   * @param r
   *          Rectangle representing the desired bounding box of the text editing
   *          widget
   */
   ...
   * specified bounding box. Use stopEditing() to hide the text widget. Use the
   * method calls getTextEditor().getText() to get the resulting edited text.
   * 
   * @param txt
   ...
   * editText() methods which include a VisualItem as an argument was called), the
   * item is updated with the edited text.
   */
