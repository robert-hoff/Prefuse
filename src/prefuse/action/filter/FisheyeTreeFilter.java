...
public class FisheyeTreeFilter extends GroupAction {
   ...
   * 
   * @param group
   *          the data group to process. This should resolve to a Graph instance,
   *          otherwise exceptions will result when this Action is run.
   */
   ...
   *          otherwise exceptions will result when this Action is run.
   * @param distance
   *          the graph distance threshold from high-interest nodes past which
   ...
   *          otherwise exceptions will result when this Action is run.
   * @param sources
   *          the group to use as source nodes, representing the nodes of highest
   *          degree-of-interest.
   * @param distance
   *          the graph distance threshold from high-interest nodes past which
   *          nodes will not be visible nor expanded.
  ...
  /**
   * Get the graph distance threshold used by this filter. This is the threshold
   * for high-interest nodes, past which nodes will not be visible nor expanded.
   * 
  ...
  /**
   * Set the graph distance threshold used by this filter. This is the threshold
   * for high-interest nodes, past which nodes will not be visible nor expanded.
   * 
   * @param distance
