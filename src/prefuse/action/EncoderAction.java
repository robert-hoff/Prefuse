...
public abstract class EncoderAction extends ItemAction {
   ...
   * subclasses should crate public add methods of their own to enforce their own
   * type constraints.
   * 
   * @param p
   *          the rule Predicate
  ...
  /**
   * Remove rules using the given predicate from this encoder. This method will
   * not remove rules in which this predicate is used within a composite of
   * clauses, such as an AND or OR. It only removes rules using this predicate as
  ...
  /**
   * Perform any necessary setup before this encoder can be used. By default does
   * nothing. Subclasses can override this method to perform custom setup before
   * the Action is used.
   */
   ...
   * does nothing. Subclasses can override this method to perform custom clean-up
  ...
  /**
   * Sets the visualization status for any Actions contained within the predicate
   * chain.
   */
