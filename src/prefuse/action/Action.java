...
public abstract class Action extends Activity {
  ...
  /**
   * Creates an action instance with zero duration. This Action will only run once
   * if invoked.
   */
  public Action() {
    this(null);
   ...
   * 
   * @param vis
   *          the Visualization this Action should process. If this Action is
   *          registered with another Visualization, this value will be
   *          overwritten.
   */
