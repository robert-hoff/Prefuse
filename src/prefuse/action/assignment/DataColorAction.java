...
public class DataColorAction extends ColorAction {
   ...
   *          the color field to assign
   * @param palette
   *          the color palette to use. See {@link prefuse.util.ColorLib} for
  ...
  /**
   * Set the scale (linear, square root, or log) to use for encoding color values
   * from the data. This value is only used for
  ...
  /**
   * Returns the number of "bins" or discrete steps of color. This value is only
  ...
  /**
   * Sets the number of "bins" or or discrete steps of color. This value is only
   * used for numerical data.
   * 
   * @param count
   ...
   * {@link prefuse.util.DataLib} class. This method allows you to set your own
   * custom ordering. This ordering corresponds to the ordering of colors in this
   * action's color palette. If the provided array of values is missing a value
   * contained within the data, an exception will result during execution of this
   * action.
   * 
   * @param values
   *          the ordered list of values. If this array is missing a value
   *          contained within data processed by this action, an exception will be
   *          thrown when this action is run.
   */
  ...
  /**
   * Computes the distribution (either min/max or quantile values) used to help
   * assign colors to data values.
   */
