...
public class DataShapeAction extends ShapeAction {
   ...
   *          the data field to base shape assignments on
   * @param palette
   *          a palette of shape values to use for the encoding. By default, shape
   *          values are assumed to be one of the integer SHAPE codes included in
   *          the {@link prefuse.Constants} class.
   */
