...
public class StrokeAction extends EncoderAction {
  ...
  /**
   * Set the default BasicStroke to be assigned to items. Items will be assigned
   * the default Stroke if they do not match any registered rules.
   * 
   * @param f
  ...
  /**
   * Add a mapping rule to this StrokeAction. VisualItems that match the provided
   * predicate will be assigned the given BasicStroke value (assuming they do not
  ...
  /**
   * Add a mapping rule to this StrokeAction. VisualItems that match the provided
   * expression will be assigned the given BasicStroke value (assuming they do not
   * match an earlier rule). The provided expression String will be parsed to
  ...
  /**
   * Add a mapping rule to this StrokeAction. VisualItems that match the provided
   * predicate will be assigned the BasicStroke value returned by the given
   * StrokeAction's getStroke() method.
   * 
   * @param p
   *          the rule Predicate
   * @param f
  ...
  /**
   * Returns the stroke to use for a given VisualItem. Subclasses should override
   * this method to perform customized Stroke assignment.
   * 
   * @param item
