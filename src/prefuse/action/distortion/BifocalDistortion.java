...
public class BifocalDistortion extends Distortion {
   ...
   * The same range and magnification is used for both axes.
   * </p>
   * 
   * <p>
   ...
   * 
   * @param range
   *          the range around the focus that should be magnified. This specifies
   *          the size of the magnified focus region, and should be in the range
   *          of 0 to 1, 0 being no magnification range and 1 being the whole
   *          display.
   * @param mag
   ...
   * 
   * @param xrange
   *          the range around the focus that should be magnified along the x
   *          direction. This specifies the horizontal size of the magnified focus
   *          region, and should be a value between 0 and 1, 0 indicating no focus
   *          region and 1 indicating the whole display.
   * @param xmag
   *          how much magnification along the x direction should be used in the
   *          focal area
   * @param yrange
   *          the range around the focus that should be magnified along the y
   *          direction. This specifies the vertical size of the magnified focus
   *          region, and should be a value between 0 and 1, 0 indicating no focus
   *          region and 1 indicating the whole display.
   * @param ymag
   *          how much magnification along the y direction should be used in the
   *          focal area
   */
