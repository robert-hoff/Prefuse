 ...
 * <a href="http://citeseer.ist.psu.edu/sarkar92graphical.html">
...
public class FisheyeDistortion extends Distortion {
  ...
  /**
   * Create a new FisheyeDistortion with the given distortion factor for use along
  ...
  /**
   * Create a new FisheyeDistortion with the given distortion factors along the x
   * and y directions.
   * 
   * @param xfactor
