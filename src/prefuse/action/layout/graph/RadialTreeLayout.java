...
public class RadialTreeLayout extends TreeLayout {
  ...
  /**
   * Creates a new RadialTreeLayout. Automatic scaling of the radius values to fit
   * the layout bounds is enabled by default.
   * 
   * @param group
   *          the data group to process. This should resolve to either a Graph or
   *          Tree instance.
   */
  ...
  /**
   * Creates a new RadialTreeLayout using the specified radius increment between
   * levels of the layout. Automatic scaling of the radius values is disabled by
   * default.
   * 
   * @param group
   *          the data group to process. This should resolve to either a Graph or
   *          Tree instance.
   * @param radius
   *          the radius increment to use between subsequent rings in the layout.
   */
  ...
  /**
   * Set the radius increment to use between concentric circles. Note that this
   * value is used only if auto-scaling is disabled.
   * 
  ...
  /**
   * Set whether or not the layout should automatically scale itself to fit the
   * layout bounds.
   * 
   * @param s
  ...
  /**
   * Clears references to graph tuples. The group and visualization are retained.
   */
  @Override
  public void reset() {
    super.reset();
  ...
  /**
   * Computes relative measures of the angular widths of each expanded subtree.
   * Node diameters are taken into account to improve space allocation for
