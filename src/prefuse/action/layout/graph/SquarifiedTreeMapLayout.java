...
public class SquarifiedTreeMapLayout extends TreeLayout {
  ...
  /**
   * Creates a new SquarifiedTreeMapLayout with no spacing between parent areas
   * and their enclosed children.
   * 
   * @param group
   ...
   * 
   * @param frame
   *          the amount of desired framing space between parent areas and their
   *          enclosed children.
   * @param group
   *          the data group to layout. Must resolve to a Graph instance.
   */
  ...
  /**
   * Sets the amount of desired framing space between parent rectangles and their
   * enclosed children. Use a value of 0 to remove frames altogether. If you
   * adjust the frame value, you must re-run the layout to see the change
