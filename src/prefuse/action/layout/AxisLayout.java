...
public class AxisLayout extends Layout {
   ...
   *          {@link prefuse.Constants#Y_AXIS}.
   * @param filter
   *          an optional predicate filter for limiting which items to layout.
   */
  ...
  /**
   * Set the data field used by this axis layout action. The values of the data
   * field will determine the position of items along the axis. Note that this
   * method does not affect the other parameters of this action. In particular,
   * clients that have provided a custom range model for setting the axis range
   * may need to appropriately update the model setting for use with the new data
   * field setting.
   * 
   * @param field
  ...
  /**
   * Get the data field used by this axis layout action. The values of the data
   * field determine the position of items along the axis.
   * 
  ...
  /**
   * Set the range model determining the span of the axis. This model controls the
   * minimum and maximum values of the layout, as provided by the
  ...
  /**
   * Get the range model determining the span of the axis. This model controls the
   * minimum and maximum values of the layout, as provided by the
   * {@link prefuse.util.ui.ValuedRangeModel#getLowValue()} and
   * {@link prefuse.util.ui.ValuedRangeModel#getHighValue()} methods.
   * 
  ...
  /**
   * Set a predicate filter to limit which items are considered for layout. Only
   * items for which the predicate returns a true value are included in the layout
   * computation.
   * 
   * @param filter
  ...
  /**
   * Get the predicate filter to limit which items are considered for layout. Only
   * items for which the predicate returns a true value are included in the layout
   * computation.
   * 
   * @return the predicate filter used by this layout. If null, no filtering is
   *         performed.
   */
   ...
   *         {@link prefuse.Constants#SQRT_SCALE}, or {@link Constants#LOG_SCALE}.
   */
  public int getScale() {
    return m_scale;
  }
  ...
  /**
   * Return the axis type of this layout, either {@link prefuse.Constants#X_AXIS}
