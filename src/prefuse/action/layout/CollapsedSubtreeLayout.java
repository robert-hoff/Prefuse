...
public class CollapsedSubtreeLayout extends Layout {
  ...
  /**
   * Create a new CollapsedSubtreeLayout. By default, nodes will collapse to the
   * center point of their parents.
   * 
   * @param group
   *          the data group to layout (only newly collapsed or newly expanded
   *          items will be considered, as determined by their current visibility
   *          settings).
   */
  ...
  /**
   * Get the layout orientation, determining which point nodes will collapse or
   * exapnd from. Valid values are {@link prefuse.Constants#ORIENT_CENTER},
   * {@link prefuse.Constants#ORIENT_LEFT_RIGHT},
   * {@link prefuse.Constants#ORIENT_RIGHT_LEFT},
   * {@link prefuse.Constants#ORIENT_TOP_BOTTOM}, and
   * {@link prefuse.Constants#ORIENT_BOTTOM_TOP}.
  ...
  /**
   * Set the layout orientation, determining which point nodes will collapse or
   * exapnd from. Valid values are {@link prefuse.Constants#ORIENT_CENTER},
   * {@link prefuse.Constants#ORIENT_LEFT_RIGHT},
   * {@link prefuse.Constants#ORIENT_RIGHT_LEFT},
   * {@link prefuse.Constants#ORIENT_TOP_BOTTOM}, and
