...
public class GridLayout extends Layout {
  ...
  /**
   * Create a new GridLayout without preset dimensions. The layout will attempt to
   * analyze an input graph to determine grid parameters.
   * 
   * @param group
  ...
  /**
   * Analyzes a set of nodes to try and determine grid dimensions. Currently looks
   * for the edge count on a node to drop to 2 to determine the end of a row.
   * 
   * @param ts
   *          TupleSet ts a set of nodes to analyze. Contained tuples <b>must</b>
   *          implement be Node instances.
