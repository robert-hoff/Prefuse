...
public class SpecifiedLayout extends Layout {
   ...
   * 
   * @param xField
   *          the x-value field to use. If null, this action will not set the
   *          x-coordiante.
   */
   ...
   * 
   * @param yField
   *          the y-value field to use. If null, this action will not set the
   *          y-coordiante.
   */
   ...
   * 
   * @return the fixed field. If null, this action does not set the fixed field.
   */
   ...
   * 
   * @param fixedField
   *          the fixed field to use. If null, this action will not set the fixed
   *          field.
   */
