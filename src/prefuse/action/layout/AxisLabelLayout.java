...
public class AxisLabelLayout extends Layout {
   ...
   *          the data group of the axis lines and labels
   * @param layout
   *          an {@link AxisLayout} instance to model this layout after. The axis
   *          type and range model of the provided instance will be used.
   */
  ...
  /**
   * Indicates if the axis values should be presented in ascending order along the
   * axis.
   * 
   * @return true if data values increase as pixel coordinates increase, false if
   *         data values decrease as pixel coordinates increase.
   */
   ...
   * 
   * @param asc
   *          true if data values should increase as pixel coordinates increase,
   *          false if data values should decrease as pixel coordinates increase.
   */
  ...
  /**
   * Calculates a quantitative, logarithmically-scaled layout. TODO: This method
