...
public class ActivityManager extends Thread {
  ...
  /**
   * Stops the activity manager thread. All scheduled actvities are canceled, and
   * then the thread is then notified to stop running.
   */
  ...
  /**
   * Schedules an Activity at the specified startTime, overwriting the Activity's
   * currently set startTime.
   * 
   * @param a
   *          the Activity to schedule
  ...
  /**
   * Schedules an Activity to start immediately after another Activity. The second
  ...
  /**
   * Cancels an Activity and removes it from this manager, called by an Activity
   * when the activity needs to be cancelled.
   * 
   * @param a
  ...
  /**
   * Cancels an action, called by an Activity when it is cancelled. Application
   * code should not call this method! Instead, use Activity.cancel() to stop a
   * sheduled or running Activity.
   * 
   * @param a
   *          The Activity to cancel
   */
  ...
  /**
   * Removes an Activity from this manager, called by an Activity when it finishes
   * or is cancelled. Application code should not call this method! Instead, use
   * Activity.cancel() to stop a sheduled or running Activity.
   * 
   * @param a
   * @return true if the activity was found and removed, false if the activity is
   *         not scheduled with this manager.
   */
  ...
  /**
   * Used by the activity loop to determine if the ActivityManager thread should
