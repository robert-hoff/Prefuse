...
public class ShapeRenderer extends AbstractShapeRenderer {
  ...
  /**
   * Sets the base size, in pixels, for shapes drawn by this renderer. The base
   * size is the width and height value used when a VisualItem's size value is 1.
   * The base size is scaled by the item's size value to arrive at the final scale
   * used for rendering.
   * 
   * @param size
   *          the base size in pixels
