...
public class LabelRenderer extends AbstractShapeRenderer {
  ...
  /**
   * Create a new LabelRenderer. By default the field "label" is used as the field
   * name for looking up text, and no image is used.
   */
  ...
  /**
   * Create a new LabelRenderer. Draws a text label using the given text data
   * field, and draws the image at the location reported by the given image data
   * field.
   * 
   * @param textField
   *          the data field for the text label
   * @param imageField
   *          the data field for the image location. This value in the data field
   *          should be a URL, a file within the current classpath, a file on the
  ...
  /**
   * Get the data field for image locations. The value stored in the data field
   * should be a URL, a file within the current classpath, a file on the
  ...
  /**
   * Set the data field for image locations. The value stored in the data field
   * should be a URL, a file within the current classpath, a file on the
   * filesystem, or null for no image. If the <code>imageField</code> parameter is
   ...
   * This scaling is enforced immediately upon loading of the image.
   * 
   * @param width
  ...
  /**
   * Returns a location string for the image to draw. Subclasses can override this
   * class to perform custom image selection beyond looking up the value from a
   * data field.
   * 
   * @param item
  ...
  /**
   * Get the image position, determining where the image is placed with respect to
   * the text. One of {@link Constants#LEFT}, {@link Constants#RIGHT},
   * {@link Constants#TOP}, or {@link Constants#BOTTOM}. The default is left.
   * 
  ...
  /**
   * Set the image position, determining where the image is placed with respect to
   * the text. One of {@link Constants#LEFT}, {@link Constants#RIGHT},
   * {@link Constants#TOP}, or {@link Constants#BOTTOM}. The default is left.
   * 
   * @param pos
