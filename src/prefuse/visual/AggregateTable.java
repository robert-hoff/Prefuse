...
public class AggregateTable extends VisualTable {
  ...
  /**
   * Get the size of the aggregate represented at the given table row. Returns the
   * number of visual items contained in the aggregation.
   * 
  ...
  /**
   * Clears all aggregates mappings for the aggregate at the given row, optionally
   * issuing a table update.
   * 
   * @param row
  ...
  /**
   * Get the row index to the aggregate mapping table for the given aggregate and
   * contained VisualItem.
   * 
   * @param row
   *          the table row of the aggregate
   * @param member
  ...
  /**
   * Check a row for validity, optionally throwing an exception when an invalid
   * row is found.
   * 
   * @param row
   *          the row to check
   * @param throwException
   *          indicates if an exception should be thrown when an invalid row is
   *          encountered
