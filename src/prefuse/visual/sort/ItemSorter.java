...
public class ItemSorter implements Comparator {
   ...
   * normal VisualItem instances. A zero score is returned for normal items, with
   * scores starting at 1&lt;&lt;27 for other items, leaving the number range
   * beneath that value open for additional nuanced scoring.
   * </p>
   * 
   * <p>
   ...
   * @return -1 if score(v1) &lt; score(v2), 1 if score(v1) &gt; score(v2) and 0
