...
public interface VisualItem extends Tuple {
  ...
  /**
   * Get the primary data group of which this VisualItem is a member. Returns the
   * name of the group of this item's backing VisualTable.
   * 
  ...
  /**
   * Indicates if this item is a member of a given group. This includes both the
   * item's primary group (that of it's backing VisualTable) and any number of
   * additional focus groups associated with the Visualization.
   * 
   * @param group
   ...
   * This could be a Table, Graph, or Tree instance. This method returns null if
   * this VisualItem is not derived from backing data.
   * 
   * @return the backing data set from which this VisualItem is derived, or null
   *         if none.
   */
   ...
   * derived. This could be a Tuple, Node, or Edge instance. This method returns
   * null if this VisualItem is not derived from backing data.
   * 
   * @return the backing data tuple from which this VisualItem is derived, or null
   *         if none.
   */
   ...
   * retrieved by requesting it from the backing Visualization's RendererFactory.
   * 
  ...
  /**
   * Validate the bounds of this VisualItem. When a data value for a VisualItem is
   * updated, it's bounds are invalidated, as the data change may have changed to
   * appearance of the item. Revalidating the bounds causes the bounds of the item
   * to be recomputed and made current.
   * 
  ...
  /**
   * Indicates if this VisualItem is currently validated. If not, validateBounds()
   * must be run to update the bounds to a current value.
   * 
  ...
  /**
   * Set this item's validated flag. This is for internal use by prefuse and, in
   * general, should not be called by application code.
   * 
   * @param value
  ...
  /**
   * Indicates if this VisualItem is currently set to be visible. Items with the
   * visible flag set false will not be drawn by a display. Invisible items are
   * also by necessity not interactive, regardless of the value of the interactive
   * flag.
   * 
  ...
  /**
   * Indicates if the start visible flag is set to true. This is the visibility
   * value consulted for the staring value of the visibility field at the
   * beginning of an animated transition.
   * 
  ...
  /**
   * Indictes if the end visible flag is set to true. This is the visibility value
   * consulted for the ending value of the visibility field at the end of an
   * animated transition.
   * 
  ...
  /**
   * Indicates if this item is interactive, meaning it can potentially respond to
  ...
  /**
   * Indicates this item is expanded. Only used for items that are part of a graph
   * structure.
   * 
  ...
  /**
   * Indicates if the item is fixed, and so will not have its position changed by
   * any layout or distortion actions.
   * 
   ...
   * interpreted by the system depends on the various processing actions set up
   * for an application (e.g., how a {@link prefuse.action.assignment.ColorAction}
  ...
  /**
   * Set the hover flag. This is set automatically by the prefuse framework, so
   * should not need to be set explicitly by application code.
   * 
   * @param value
  ...
  /**
   * Get the bounding box for this VisualItem. If necessary, the bounds will be
   * validated before returning the bounding box.
   * 
  ...
  /**
   * Set the bounding box for this item. This method is used by Renderer modules
  ...
  /**
   * Get the current stroke color of this item. The stroke color is used to draw
   * lines and the outlines of shapes. Color values as represented as an integer
   * containing the red, green, blue, and alpha (transparency) color channels. A
   * color with a zero alpha component is fully transparent and will not be drawn.
   * 
  ...
  /**
   * Set the current stroke color of this item. The stroke color is used to draw
   * lines and the outlines of shapes. Color values as represented as an integer
   * containing the red, green, blue, and alpha (transparency) color channels. A
   * color with a zero alpha component is fully transparent and will not be drawn.
   * 
  ...
  /**
   * Get the starting stroke color of this item. The stroke color is used to draw
   * lines and the outlines of shapes. Color values as represented as an integer
   * containing the red, green, blue, and alpha (transparency) color channels. A
   * color with a zero alpha component is fully transparent and will not be drawn.
   * 
  ...
  /**
   * Set the starting stroke color of this item. The stroke color is used to draw
   * lines and the outlines of shapes. Color values as represented as an integer
   * containing the red, green, blue, and alpha (transparency) color channels. A
   * color with a zero alpha component is fully transparent and will not be drawn.
   * 
  ...
  /**
   * Get the ending stroke color of this item. The stroke color is used to draw
   * lines and the outlines of shapes. Color values as represented as an integer
   * containing the red, green, blue, and alpha (transparency) color channels. A
   * color with a zero alpha component is fully transparent and will not be drawn.
   * 
  ...
  /**
   * Set the ending stroke color of this item. The stroke color is used to draw
   * lines and the outlines of shapes. Color values as represented as an integer
   * containing the red, green, blue, and alpha (transparency) color channels. A
   * color with a zero alpha component is fully transparent and will not be drawn.
   * 
  ...
  /**
   * Get the current fill color of this item. The fill color is used to fill the
   * interior of shapes. Color values as represented as an integer containing the
   * red, green, blue, and alpha (transparency) color channels. A color with a
   * zero alpha component is fully transparent and will not be drawn.
   * 
  ...
  /**
   * Set the current fill color of this item. The fill color is used to fill the
   * interior of shapes. Color values as represented as an integer containing the
   * red, green, blue, and alpha (transparency) color channels. A color with a
   * zero alpha component is fully transparent and will not be drawn.
   * 
  ...
  /**
   * Get the starting fill color of this item. The fill color is used to fill the
   * interior of shapes. Color values as represented as an integer containing the
   * red, green, blue, and alpha (transparency) color channels. A color with zero
   * alpha component is fully transparent and will not be drawn.
   * 
  ...
  /**
   * Set the starting fill color of this item. The fill color is used to fill the
   * interior of shapes. Color values as represented as an integer containing the
   * red, green, blue, and alpha (transparency) color channels. A color with a
   * zero alpha component is fully transparent and will not be drawn.
   * 
  ...
  /**
   * Get the ending fill color of this item. The fill color is used to fill the
   * interior of shapes. Color values as represented as an integer containing the
   * red, green, blue, and alpha (transparency) color channels. A color with zero
   * alpha component is fully transparent and will not be drawn.
   * 
  ...
  /**
   * Set the ending fill color of this item. The fill color is used to fill the
   * interior of shapes. Color values as represented as an integer containing the
   * red, green, blue, and alpha (transparency) color channels. A color with a
   * zero alpha component is fully transparent and will not be drawn.
   * 
  ...
  /**
   * Get the current text color of this item. The text color is used to draw text
   * strings for the item. Color values as represented as an integer containing
   * the red, green, blue, and alpha (transparency) color channels. A color with
   * zero alpha component is fully transparent and will not be drawn.
   * 
  ...
  /**
   * Set the current text color of this item. The text color is used to draw text
   * strings for the item. Color values as represented as an integer containing
   * the red, green, blue, and alpha (transparency) color channels. A color with a
   * zero alpha component is fully transparent and will not be drawn.
   * 
   * @param color
  ...
  /**
   * Get the starting text color of this item. The text color is used to draw text
   * strings for the item. Color values as represented as an integer containing
   * the red, green, blue, and alpha (transparency) color channels. A color with
   * zero alpha component is fully transparent and will not be drawn.
   * 
  ...
  /**
   * Set the starting text color of this item. The text color is used to draw text
   * strings for the item. Color values as represented as an integer containing
   * the red, green, blue, and alpha (transparency) color channels. A color with a
   * zero alpha component is fully transparent and will not be drawn.
   * 
  ...
  /**
   * Get the ending text color of this item. The text color is used to draw text
   * strings for the item. Color values as represented as an integer containing
   * the red, green, blue, and alpha (transparency) color channels. A color with
   * zero alpha component is fully transparent and will not be drawn.
   * 
  ...
  /**
   * Set the ending text color of this item. The text color is used to draw text
   * strings for the item. Color values as represented as an integer containing
   * the red, green, blue, and alpha (transparency) color channels. A color with a
   * zero alpha component is fully transparent and will not be drawn.
   * 
  ...
  /**
   * Get the starting size value of the item. Size values are typically used to
   * scale an item, either in one-dimension (e.g., a bar chart length) or
   * two-dimensions (e.g., using pixel area to encode a quantitative value).
   * 
  ...
  /**
   * Set the starting size value of the item. Size values are typically used to
   * scale an item, either in one-dimension (e.g., a bar chart length) or
   * two-dimensions (e.g., using pixel area to encode a quantitative value).
   * 
   * @param size
  ...
  /**
   * Get the current shape value of the item. One of the SHAPE constants included
   * in the {@link prefuse.Constants} class. This value only has an effect if a
   * Renderer that supports different shapes is used (e.g.,
  ...
  /**
   * Set the current shape value of the item. One of the SHAPE constants included
   * in the {@link prefuse.Constants} class. This value only has an effect if a
   * Renderer that supports different shapes is used (e.g.,
   * {@link prefuse.render.ShapeRenderer}.
   * 
  ...
  /**
   * Get the current font for the item. The font is used as the default typeface
  ...
  /**
   * Set the current font for the item. The font is used as the default typeface
   * for drawing text for this item.
   * 
   * @param font
  ...
  /**
   * Get the starting font for the item. The font is used as the default typeface
   * for drawing text for this item.
   * 
  ...
  /**
   * Set the starting font for the item. The font is used as the default typeface
   * for drawing text for this item.
   * 
   * @param font
  ...
  /**
   * Get the ending font for the item. The font is used as the default typeface
   * for drawing text for this item.
   * 
  ...
  /**
   * Set the ending font for the item. The font is used as the default typeface
   * for drawing text for this item.
   * 
   * @param font
  ...
  /**
   * Get the degree-of-interest (DOI) value. The degree-of-interet is an optional
   * value that can be used to sort items by importance, control item visibility,
   * or influence particular visual encodings. A common example is to use the DOI
   * to store the graph distance of a node from the nearest selected focus node.
   * 
  ...
  /**
   * Set the degree-of-interest (DOI) value. The degree-of-interet is an optional
   * value that can be used to sort items by importance, control item visibility,
   * or influence particular visual encodings. A common example is to use the DOI
   * to store the graph distance of a node from the nearest selected focus node.
   * 
