...
public class VisualTree extends Tree implements VisualTupleSet {
   ...
   * @param nodeKey
   *          the node table field by which to index the nodes. This value can be
   *          null, indicating that just the row indices should be used.
   * @param sourceKey
  ...
  /**
   * Fire a graph event. Makes sure to invalidate all edges connected to a node
