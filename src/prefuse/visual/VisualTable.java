...
public class VisualTable extends CascadedTable implements VisualTupleSet {
  ...
  /**
   * Indicates if the given row is currently validated. If not, validateBounds()
  ...
  /**
   * Set the given row's validated flag. This is for internal use by prefuse and,
  ...
  /**
   * Indicates the given row is expanded. Only used for items that are part of a
   * graph structure.
   * 
   * @param row
   *          the table row
  ...
  /**
   * Returns the bounds for the VisualItem at the given row index. The returned
   * reference is for the actual bounds object used by the system -- do <b>NOT</b>
   * directly edit the values in this returned object!! This will corrupt the
   * state of the system.
   * 
   * @param row
   *          the table row
  ...
  /**
   * Get the starting stroke color of the row. The stroke color is used to draw
   * lines and the outlines of shapes. Color values as represented as an integer
   * containing the red, green, blue, and alpha (transparency) color channels. A
   * color with a zero alpha component is fully transparent and will not be drawn.
   * 
  ...
  /**
   * Set the starting stroke color of the row. The stroke color is used to draw
   * lines and the outlines of shapes. Color values as represented as an integer
   * containing the red, green, blue, and alpha (transparency) color channels. A
   * color with a zero alpha component is fully transparent and will not be drawn.
   * 
  ...
  /**
   * Set the current fill color of the row. The stroke color is used to fill the
   * interior of shapes. Color values as represented as an integer containing the
   * red, green, blue, and alpha (transparency) color channels. A color with a
   * zero alpha component is fully transparent and will not be drawn.
   * 
  ...
  /**
   * Get the starting fill color of the row. The fill color is used to fill the
   * interior of shapes. Color values as represented as an integer containing the
  ...
  /**
   * Set the starting fill color of the row. The stroke color is used to fill the
   * interior of shapes. Color values as represented as an integer containing the
   * red, green, blue, and alpha (transparency) color channels. A color with a
   * zero alpha component is fully transparent and will not be drawn.
   * 
  ...
  /**
   * Set the ending fill color of the row. The stroke color is used to fill the
   * interior of shapes. Color values as represented as an integer containing the
   * red, green, blue, and alpha (transparency) color channels. A color with a
   * zero alpha component is fully transparent and will not be drawn.
   * 
  ...
  /**
   * Get the current text color of the row. The text color is used to draw text
  ...
  /**
   * Set the current text color of the row. The text color is used to draw text
   * strings for the item. Color values as represented as an integer containing
  ...
  /**
   * Get the starting text color of the row. The text color is used to draw text
   * strings for the item. Color values as represented as an integer containing
   * the red, green, blue, and alpha (transparency) color channels. A color with
   * zero alpha component is fully transparent and will not be drawn.
   * 
  ...
  /**
   * Set the starting text color of the row. The text color is used to draw text
   * strings for the item. Color values as represented as an integer containing
   * the red, green, blue, and alpha (transparency) color channels. A color with a
   * zero alpha component is fully transparent and will not be drawn.
   * 
  ...
  /**
   * Get the ending size value of the row. Size values are typically used to scale
   * an item, either in one-dimension (e.g., a bar chart length) or two-dimensions
   * (e.g., using pixel area to encode a quantitative value).
   * 
   * @param row
   *          the table row
  ...
  /**
   * Set the ending size value of the row. Size values are typically used to scale
   * an item, either in one-dimension (e.g., a bar chart length) or two-dimensions
   * (e.g., using pixel area to encode a quantitative value).
   * 
   * @param row
  ...
  /**
   * Get the current shape value of the row. One of the SHAPE constants included
  ...
  /**
   * Set the current shape value of the row. One of the SHAPE constants included
   * in the {@link prefuse.Constants} class. This value only has an effect if a
   * Renderer that supports different shapes is used (e.g.,
   * {@link prefuse.render.ShapeRenderer}.
   * 
  ...
  /**
   * Get the current stroke used to draw lines and shape outlines for the item at
   * the given row.
   * 
  ...
  /**
   * Get the current font for the row. The font is used as the default typeface
  ...
  /**
   * Get the starting font for the row. The font is used as the default typeface
   * for drawing text for this item.
   * 
   * @param row
   *          the table row
  ...
  /**
   * Set the starting font for the row. The font is used as the default typeface
   * for drawing text for this item.
   * 
   * @param row
   *          the table row to set
  ...
  /**
   * Get the ending font for the row. The font is used as the default typeface for
   * drawing text for this item.
   * 
   * @param row
   *          the table row
  ...
  /**
   * Set the ending font for the row. The font is used as the default typeface for
   * drawing text for this item.
   * 
   * @param row
   *          the table row to set
