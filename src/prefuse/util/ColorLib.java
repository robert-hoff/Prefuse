...
public class ColorLib {
  ...
  /**
   * Parse a hexadecimal String as a color code. The color convention is the same
   * as that used in webpages, with two-decimal hexadecimal numbers representing
   * RGB color values in the range 0-255. A single '#' character may be included
   * at the beginning of the String, but is not required. For example '#000000' is
   * black, 'FFFFFF' is white, '0000FF' is blue, and '#FFFF00' is orange. Color
   * values may also include transparency (alpha) values, ranging from 00 (fully
   * transparent) to FF (fully opaque). If included, alpha values should come
   * first in the string. For example, "#770000FF" is a translucent blue.
   * 
   * @param hex
   ...
   * 
   * @param h
   *          the hue value (in the range 0-1.0). This represents the actual color
   *          hue (blue, green, purple, etc).
   * @param s
   *          the saturation value (in the range 0-1.0). This represents "how
   *          much" of the color is included. Lower values can result in more
   *          grayed out or pastel colors.
   * @param b
   *          the brightness value (in the range 0-1.0). This represents how dark
  ...
  /**
   * Get a Java Color object for the given red, green, blue, and alpha values as
   * floating point numbers in the range 0-1.0.
   * 
   * @param r
   *          the red color component (in the range 0-1.0)
  ...
  /**
   * Get a Java Color object for the given red, green, and blue values as floating
   * point numbers in the range 0-1.0.
   * 
   * @param r
   *          the red color component (in the range 0-1.0)
   * @param g
  ...
  /**
   * Interpolate between two color values by the given mixing proportion. A mixing
   * fraction of 0 will result in c1, a value of 1.0 will result in c2, and value
   * of 0.5 will result in the color mid-way between the two in RGB color space.
   * 
   * @param c1
   *          the starting color
   * @param c2
   *          the target color
   * @param frac
   *          a fraction between 0 and 1.0 controlling the interpolation amount.
  ...
  public static int interp(int c1, int c2, double frac) {
    ...
    return rgba((int) Math.round(frac * red(c2) + ifrac * red(c1)),
        (int) Math.round(frac * green(c2) + ifrac * green(c1)), (int) Math.round(frac * blue(c2) + ifrac * blue(c1)),
  ...
  public static int brighter(int c) {
    ...
    return rgba(Math.min(255, (int) (r / scale)), Math.min(255, (int) (g / scale)), Math.min(255, (int) (b / scale)),
        alpha(c));
  }
  ...
  /**
   * Returns a color palette of default size that uses a "cool", blue-heavy color
   * scheme.
   * 
   * @return the color palette
   */
  ...
  /**
   * Returns a color map of default size that moves from black to red to yellow to
   * white.
   * 
   * @return the color palette
   */
  ...
  /**
   * Returns a color palette of given size tries to provide colors appropriate as
   * category labels. There are 12 basic color hues (red, orange, yellow, olive,
   * green, cyan, blue, purple, magenta, and pink). If the size is greater than
   * 12, these colors will be continually repeated, but with varying saturation
   * levels.
   * 
   * @param size
   *          the size of the color palette
  ...
  /**
   * Returns a color palette of given size that cycles through the hues of the HSB
  ...
  /**
   * Returns a color palette of default size that cycles through the hues of the
   * HSB (Hue/Saturation/Brightness) color space at full saturation and
   * brightness.
   * 
   * @return the color palette
   */
  ...
  /**
   * Returns a color palette of given size that ranges from one given color to the
   * other.
   * 
   * @param size
   *          the size of the color palette
  ...
  /**
   * Returns a color palette of default size that ranges from one given color to
   * the other.
   * 
   * @param c1
   *          the initial color in the color map
