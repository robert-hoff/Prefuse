...
public interface Force {
  ...
  /**
   * Get the suggested minimum value for a parameter. This value is not strictly
   * enforced, but is used by interface components that allow force parameters to
   * be varied.
   * 
   * @param param
   *          the parameter index
  ...
  /**
   * Get the suggested maximum value for a parameter. This value is not strictly
   * enforced, but is used by interface components that allow force parameters to
   * be varied.
   * 
   * @param param
  ...
  /**
   * Set the suggested minimum value for a parameter. This value is not strictly
   * enforced, but is used by interface components that allow force parameters to
   * be varied.
   * 
   * @param i
  ...
  /**
   * Set the suggested maximum value for a parameter. This value is not strictly
   * enforced, but is used by interface components that allow force parameters to
   * be varied.
   * 
   * @param i
