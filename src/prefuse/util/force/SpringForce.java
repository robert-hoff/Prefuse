...
public class SpringForce extends AbstractForce {
   ...
   * 
   * @param springCoeff
   *          the default spring co-efficient to use. This will be used if the
   *          spring's own co-efficient is less than zero.
   * @param defaultLength
   *          the default spring length to use. This will be used if the spring's
   *          own length is less than zero.
   */
