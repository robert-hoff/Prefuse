 ...
 * <ul>
 * <li><a href=
 * "http://www.cs.berkeley.edu/~demmel/cs267/lecture26/lecture26.html">James
 * Demmel's UC Berkeley lecture notes</a>
 * <li><a href=
 * "http://www.physics.gmu.edu/~large/lr_forces/desc/bh/bhdesc.html">Description
 * of the Barnes-Hut algorithm</a>
 * <li><a href=
 * "http://www.ifa.hawaii.edu/~barnes/treecode/treeguide.html">Joshua Barnes'
 * recent implementation</a>
 * </ul>
 * </p>
 * 
...
public class NBodyForce extends AbstractForce {
  ...
  /*
   * The indexing scheme for quadtree child nodes goes row by row. 0 | 1 0 -> top
   * left, 1 -> top right ------- 2 | 3 2 -> bottom left, 3 -> bottom right
   */
   ...
   * 
   * @param gravConstant
   *          the gravitational constant to use. Nodes will attract each other if
   *          this value is positive, and will repel each other if it is negative.
   * @param minDistance
   *          the distance within which two particles will interact. If -1, the
   *          value is treated as infinite.
   * @param theta
   *          the Barnes-Hut parameter theta, which controls when an aggregated
   *          mass is used rather than drilling down to individual item mass
   *          values.
   */
   ...
   *           if the current location of the item is outside the bounds of the
   *           quadtree
   */
  ...
  /**
   * Helper class to minimize number of object creations across multiple uses of
   * the quadtree.
   */
