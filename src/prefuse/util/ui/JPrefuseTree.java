...
public class JPrefuseTree extends JTree {
  ...
  /**
   * Returns a String label for Node instances by looking up the label data field
  ...
  /**
   * TreeModel implementation that provides an adapter to a backing prefuse Tree
   * instance.
   */
