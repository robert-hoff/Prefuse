...
public class UILib {
  ...
  /**
   * Set the look and feel of Java Swing user interface components to match that
   * of the platform (Windows, Mac, Linux, etc) on which it is currently running.
   */
   ...
   * @param horiz
   *          indicated is the box should be horizontal (true) or vertical (false)
   * @param margin
   ...
   * @param horiz
   *          indicates if the strust should horizontal (true) or vertical (false)
   * @param size
   ...
   *          Container using a BoxLayout.
   * @param horiz
   *          indicates if the glue should horizontal (true) or vertical (false)
   */
   ...
   * 
   * @param c
   *          a Swing Component, should be either a Box or a Container using a
   *          BoxLayout.
   * @param layout
  ...
  /**
   * Sets the foreground and background color for a component and all components
   * contained within it.
   * 
   * @param c
