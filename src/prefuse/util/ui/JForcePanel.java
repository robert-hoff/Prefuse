...
public class JForcePanel extends JPanel {
  ...
  /**
   * Create and displays a new window showing a configuration panel for the given
   * ForceSimulator.
   * 
   * @param fsim
   *          the force simulator
   * @return a JFrame instance containing a configuration interface for the force
   *         simulator
   */
