 ...
 * See See
 * <a href="http://examples.oreilly.com/jswing2/code/ch04/HtmlLabel.java"> this
...
public class JCustomTooltip extends JToolTip {
  ...
  /**
   * Sets if the tooltip will stay persistent on the screen to support interaction
   * within the tooltip component.
   * 
   * @param inter
  ...
  /**
   * Listener class that registers the tooltip component and performs persistence
   * management.
   */
