 ...
 * hardwired configuration settings that can be overridden by creating a text
 * properties file containing custom values. By default, prefuse will look for
...
public class PrefuseConfig extends Properties {
   ...
   * @param key
   *          the name of the property to lookup
   * @return the property value, or the minimum possible integer value if the key
   ...
   * @param key
   *          the name of the property to lookup
   * @return the property value, or the minimum possible long value if the key is
   *         not found or parsing of the number fails.
   */
   ...
   * @param key
   *          the name of the property to lookup
   * @return the property value, or a Float.NaN value if the key is not found or
   *         parsing of the number fails.
   */
   ...
   * @param key
   *          the name of the property to lookup
   * @return the property value, or a Double.NaN value if the key is not found or
   *         parsing of the number fails.
   */
   ...
   * @param key
   *          the name of the property to lookup
   * @return the property value. False is returned if the key is not found or does
   *         not parse to a true/false value.
   */
