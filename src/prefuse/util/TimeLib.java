...
public class TimeLib {
   ...
   * @param field
   *          the time unit to use, one of the {@link java.util.Calendar} fields,
   *          or one of the extended fields provided by this class (MILLENIUM,
   *          CENTURY, or DECADE).
   ...
   * @param field
   *          the time unit to increment, one of the {@link java.util.Calendar}
   ...
   * 
   * @param type
   *          the concrete subclass of the Date instance, must be an instance of
  ...
  /**
   * Get the timestamp resulting from clearing (setting to zero) all time values
   * less than or equal to that of the given field. For example, clearing to
   ...
   *          the reference time
   * @param c
   *          a Calendar instance used to help compute the value, the state of the
   *          Calendar will be overwritten.
   * @param field
   *          the time field to clear to, one of the {@link java.util.Calendar}
   *          fields, or one of the extended fields provided by this class
   *          (MILLENIUM, CENTURY, or DECADE).
  ...
  /**
   * Clear the given calendar, setting to zero all time values less than or equal
   * to that of the given field. For example, clearing to {@link Calendar#HOUR}
   * will floor the time to nearest hour which occurred before or at the given
   * time (e.g., 1:32 --> 1:30).
   * 
   * @param c
  ...
  /**
   * Indicates if a field value indicates a timespan greater than one year. These
   * multi-year spans are the extended fields introduced by this class (MILLENIUM,
   * CENTURY, and DECADE).
   * 
   * @param field
   *          the time field
