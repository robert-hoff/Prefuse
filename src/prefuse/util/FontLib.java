...
public class FontLib {
  ...
  /**
   * Get a Font instance with the given font family name and size. A plain font
   * style is assumed.
   * 
   * @param name
   *          the font name. Any font installed on your system should be valid.
   *          Common examples include "Arial", "Verdana", "Tahoma", "Times New
   ...
   *          Roman", "Georgia", and "Courier New".
   * @param style
   *          the font style, such as bold or italics. This field uses the same
   *          style values as the Java {@link java.awt.Font} class.
   * @param size
   *          the size, in points, of the font
   * @return the requested Font instance
   */
   ...
   * If the interpolation fraction is under 0.5, the face and style of the
   * starting font are used, otherwise the face and style of the second font are
   * applied.
   * 
   * @param f1
   *          the starting font
