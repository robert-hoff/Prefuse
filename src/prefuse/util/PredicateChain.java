...
public class PredicateChain {
   ...
   * 
   * @return the predicate chain, either an IfExpression or the single terminal
  ...
  /**
   * Remove rules using the given predicate from this predicate chain. This method
   * will not remove rules in which this predicate is used within a composite of
