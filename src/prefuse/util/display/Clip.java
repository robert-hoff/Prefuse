...
public class Clip {
  ...
  /**
   * Transform the clip contents. A new clip region will be created which is the
   * bounding box of the transformed region.
   * 
   * @param at
  ...
  /**
   * Intersect this clip with another region. As a result, this clip will become
   * the intersecting area of the two regions.
   * 
   * @param c
  ...
  /**
   * Grow the clip width and height by the given value. The minimum coordinates
   * will be unchanged.
   * 
   * @param b
