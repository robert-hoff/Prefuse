...
public class DisplayLib {
   ...
   * @param margin
   *          a margin to add on to the bounding rectangle
   * @return the bounding rectangle. A new Rectangle2D instance is allocated and
   *         returned.
   */
   ...
   * @param duration
   *          the duration of an animated transition. A value of zero will result
   *          in an instantaneous change.
   */
  ...
  /**
   * Set the display view such that the given bounds are within view, subject to a
   * given center point being maintained.
   * 
   * @param display
   *          the Display instance
   * @param bounds
