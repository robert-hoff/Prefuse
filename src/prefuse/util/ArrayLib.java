...
public abstract class ArrayLib {
   ...
   * @return the index of the given key if it exists in the array, otherwise -1
   *         times the index value at the insertion point that would be used if
   *         the key were added to the array.
   */
   ...
   * The range is assumed to start at index 0.
   * 
   * @param a
   *          the array to search
   * @param key
   ...
   * @param key
   *          the key to search for
   * @return the index of the first occurrence of the key in the array, of -1 if
  ...
  /**
   * Linearly search an array range for a given key value. Assumes that the range
   * begins at index 0.
   * 
   * @param a
   *          the array to search
   ...
   *          the array to trim
   * @param size
   *          the desired size of the array. This value must be lesser than or
   ...
   * StringTokenizer to segment the text file. Additionally, tokens beginning with
