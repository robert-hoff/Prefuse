...
public class PrefuseLib {
  ...
  /**
   * Group delimiter string used to demarcate the hierarchical structure of nested
   * data groups; the default value is a dot (.).
   */
  ...
  /**
   * Returns a string showing debugging info such as number of visualized items
  ...
  /**
   * Returns a scale factor by which to scale a 2D shape to grow the area by the
   * desired input size value. This is used to scale shapes by total pixel area,
   * rather than scaling each dimension by the size value itself, which grows the
   * pixel area quadratically rather than linearly.
   */
   ...
   * current value will become the new starting value, while the given value will
   * become the new current and ending values.
   * 
   * @param item
  ...
  /**
   * Update the visibility of an item. The current visibility will become the new
   * starting visibility, while the given visibility value will become the new
   * current and ending visibility.
   * 
   * @param item
   *          the VisualItem to update
   * @param val
  ...
  /**
   * Update the x-coordinate of an item. The current x value will become the new
   * starting x value, while the given value will become the new current x and
   * ending x values. This method also supports an optional referrer item, whose x
   * coordinate will become the new starting x coordinate of item if item's
   * current x value is NaN.
   * 
   * @param item
   *          the VisualItem to update
   * @param referrer
  ...
  /**
   * Update the y-coordinate of an item. The current y value will become the new
   * starting y value, while the given value will become the new current x and
   * ending y values. This method also supports an optional referrer item, whose y
   * coordinate will become the new starting y coordinate of item if item's
   * current x value is NaN.
   * 
   * @param item
   *          the VisualItem to update
  ...
  /**
   * Indicates if a group is a child group, a non-top-level data group in a set of
   * nested data groups (e.g., the node or edge table of a graph or tree).
   * 
  ...
  /**
   * Get the parent group string of a child group, stripping off the bottom-level
   * group from the group name (e.g., graph.nodes --> graph).
   * 
   * @param group
   *          the group name
  ...
  /**
   * Get the tail group name of a child group, stripping all but the bottom-level
   * group from the group name (e.g., graph.nodes --> nodes).
   * 
   * @param group
   *          the group name
  ...
  /**
   * Get the group name for the given parent and child group, simply concatenating
   * them together with a group delimiter in between.
   * 
   * @param parent
  ...
  /**
   * Get an instance of the default Schema used for VisualItem instances. Contains
   * all the data members commonly used to model a visual element, such as x,y
   * position, stroke, fill, and text, colors, size, font, and validated,
   * visibility, interactive, fixed, highlight, and mouse hover fields.
   * 
  ...
  /**
   * Get the VisualItem Schema used for axis tick marks and labels. Extends the
   * VisualItem Schema with an additional end-point coordinate, a String label
   * field, and numeric value field for storing the value which the axis label
   * corresponds to.
   * 
