...
public class XMLWriter {
   ...
   *          the print writer to write the XML to
   * @param tabLength
   *          the number of spaces to use for each level of indentation in the XML
   *          file
   */
  ...
  /**
   * Print <em>unescaped</em> text into the XML file. To print escaped text, use
   * the {@link #content(String)} method instead.
   * 
   * @param s
  ...
  /**
   * Print <em>unescaped</em> text into the XML file, followed by a newline. To
   * print escaped text, use the {@link #content(String)} method instead.
   * 
   * @param s
   *          the text to print. This String will not be escaped.
   */
   ...
   * methods. This method prints an XML header into the top of the output stream.
   */
  public void begin() {
   ...
   * Begin the XML document. This must be called before any other formatting
   * methods. This method prints an XML header into the top of the output stream,
   * plus additional header text provided by the client
   * 
   * @param header
  ...
  /**
   * Print a comment in the XML document. The comment will be printed according to
   * the current spacing and followed by a newline.
   * 
   * @param comment
   *          the comment text
   */
   ...
   * @param close
   *          true to close the tag, false to leave it open and adjust the spacing
   */
  ...
  /**
   * Print a start tag with attributes. The tag will be followed by a newline, and
   * the indentation level will be increased.
   * 
   * @param tag
   *          the tag name
   * @param names
  ...
  /**
   * Print a start tag with one attribute. The tag will be followed by a newline,
  ...
  /**
   * Print a start tag without attributes. The tag will be followed by a newline,
   * and the indentation level will be increased.
   * 
   * @param tag
   *          the tag name
  ...
  /**
   * Close the most recently opened tag. The tag will be followed by a newline,
   * and the indentation level will be decreased.
   */
  public void end() {
  ...
  /**
   * Print a new content tag with a single attribute, consisting of an open tag,
   ...
   * document. This method is used by many of the other formatting methods, and so
   * should only need to be called in the case of custom text printing outside the
