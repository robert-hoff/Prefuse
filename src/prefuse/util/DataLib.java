...
public class DataLib {
  ...
  /**
   * Get an array of doubles containing all column values for a given table and
   * field. The {@link Table#canGetDouble(String)} method must return true for the
   * given column name, otherwise an exception will be thrown.
   * 
   * @param tuples
   *          an iterator over tuples
   * @param field
  ...
  /**
   * Get a sorted array containing all column values for a given tuple iterator
   * and field.
   * 
   * @param tuples
   *          an iterator over tuples
   ...
   * @param field
   *          the column / data field name
   * @return a map mapping column values to their position in a sorted order of
   *         values
   */
  ...
  /**
   * Get the standard deviation of a tuple data value. If any tuple does not have
   * the named field or the field is not a numeric data type, NaN will be
   * returned.
   * 
   * @param tuples
   *          an iterator over tuples
   * @param field
   *          the column / data field name
   * @return the standard deviation value, or NaN if a non-numeric data type is
   *         encountered
   */
  ...
  /**
   * Get the sum of a tuple data value. If any tuple does not have the named field
   * or the field is not a numeric data type, NaN will be returned.
   * 
   * @param tuples
   *          an iterator over tuples
   * @param field
        ...
        if (type == null) {
          ...
          if (type2.isAssignableFrom(type)) {
            ...
            throw new IllegalArgumentException(
                "The data field [" + field + "] does not have " + "a consistent type across provided Tuples");
          }
        }
      }
      return type;
